/****************************************************************************/
/* OBJET3.C : Animation d'un objet contenu dans un fichier ASC              */
/*            Affichage de l'objet en fil de fer avec elimination des       */
/*            parties cach‚es - Clipping int‚gr‚ au tracage de droite       */
...
/****************************************************************************/
/* Remplir() : appel al fonction de remplissage de polygone                 */
/****************************************************************************/
