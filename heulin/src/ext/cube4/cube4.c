/****************************************************************************/
/* CUBE4.C : exemple d'animation d'un cube                		    */
...
point   Point2D[8];  /* les sommets apres projection */
...
/****************************************************************************/
/* Facettes() : Fonction de test : affiche une seule facette du cube        */
/****************************************************************************/

void Facettes(int couleur)
{
  point p[4];
